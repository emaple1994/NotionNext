...
const BLOG = {
  ...
  GREETING_WORDS: process.env.NEXT_PUBLIC_GREETING_WORDS || 'Hi，我是易枫, 很高兴认识您,欢迎来到我的桃花源🎉',

  CUSTOM_MENU: process.env.NEXT_PUBLIC_CUSTOM_MENU || true, // 支持Menu 类型，从3.12.0版本起，各主题将逐步支持灵活的二级菜单配置，替代了原来的Page类型，此配置是试验功能、默认关闭。

  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || '易枫', // yifeng易枫
  BIO: process.env.NEXT_PUBLIC_BIO || '独立广告人，品牌战略咨询顾问', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'www.yifeng07.com', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || '易枫, 博客', // 网站关键词 英文逗号隔开

  // 社交链接，不需要可留空白，例如 CONTACT_WEIBO:''
  CONTACT_EMAIL: process.env.NEXT_PUBLIC_CONTACT_EMAIL || '865423348@gmail.com', // 邮箱地址 例如mail@tangly1024.com
  CONTACT_WEIBO: process.env.NEXT_PUBLIC_CONTACT_WEIBO || 'https://weibo.com/u/2394674575', // 你的微博个人主页
  ...
  BEI_AN: process.env.NEXT_PUBLIC_BEI_AN || '备案号 粤ICP备20171007', // 备案号 闽ICP备XXXXXXX
  ...
  NOTION_PROPERTY_NAME: {
    ...
    status_publish:
          process.env.NEXT_PUBLIC_NOTION_PROPERTY_STATUS_PUBLISH || 'publish', // 当status状态值与此相同时为发布，可以为中文
    status_invisible:
